...
@section('content')
                    ...
                    <div class="rotating-card-container">
                        <div class="card card-rotate card-background card-background-mask-primary shadow-primary mt-md-0 mt-5">
                            <div class="front front-background"
                                ...
                                <div class="card-body py-7 text-center">
                                    <i class="material-icons text-white text-4xl my-3">touch_app</i>
                                    <h3 class="text-white">Trasmición en <br /> Vivo</h3>
                                </div>
                            </div>
                            <div class="back back-background"
                        ...
                        <div class="row{{ ($index % 2 == 0) ? ' flex-row-reverse' : '' }}">
                            ...
                            <div class="col-lg-6 justify-content-center d-flex flex-column ps-lg-5 pt-lg-0 pt-3">
                                ...
                                @if ($cardmain->mas_info)
                                    <p>
                                        <a href="{{$cardmain->mas_info}}" target="_blank" class="text-darker icon-move-right text-sm">
                                            Más información.
    ...
    <section class="py-sm-7" id="pricing-soft-ui">
        <div class="mt-lg-n8 mt-n6">
            <div class="container">
                <h3 class="mb-0 text-center">Con el partocinio de:</h3>
                <hr class="horizontal dark my-5">
                <div class="row">
